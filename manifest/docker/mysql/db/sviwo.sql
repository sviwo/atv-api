...
MySQL Backup
Database: sviwo
Backup Time: 2024-07-02 16:38:50
*/
...
CREATE TABLE `sw_alarm_log` (
  ...
  `product_key` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '0' COMMENT '产品标识',
  `device_key` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '设备标识',
  `status` int NOT NULL DEFAULT '0' COMMENT '告警状态：0=未处理，1=已处理',
  `content` varchar(400) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '处理意见',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='app操作日志表';
CREATE TABLE `sw_app_media` (
  ...
  `media_desc` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '简介',
  `small_img` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '缩略图',
...
CREATE TABLE `sw_device` (
  ...
  `device_secret` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '对应物联网平台颁发的设备证书的DeviceSecret',
  `device_model` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '设备型号',
  ...
  `bluetooth_address` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '蓝牙地址',
  `bluetooth_secret_key` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '蓝牙握手密钥',
  `create_time` datetime NOT NULL,
  `update_time` datetime DEFAULT NULL,
  `is_delete` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除：true=已删除，false=正常\n',
...
CREATE TABLE `sw_product` (
  ...
  `product_key` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '产品key',
  `product_model` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '产品型号',
  `status` int NOT NULL DEFAULT '0' COMMENT '发布状态：0=未发布，1=已发布',
  `metadata` longtext CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '物模型',
...
) ENGINE=InnoDB AUTO_INCREMENT=10001 DEFAULT CHARSET=utf8mb3 COMMENT='App用户表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1763157909782401025 DEFAULT CHARSET=utf8mb3 COMMENT='实名认证表';
...
CREATE TABLE `sw_version` (
  ...
  `version_code` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '版本编码',
...
INSERT INTO `sviwo`.`sw_device` (`device_id`,`product_id`,`sim_id`,`product_key`,`device_name`,`device_secret`,`device_model`,`nickname`,`status`,`online_timeout`,`activate_time`,`registry_time`,`version`,`last_online_time`,`metadata_table`,`bluetooth_address`,`bluetooth_secret_key`,`create_time`,`update_time`,`is_delete`) VALUES (10000, 10000, '111', 'k0ugjmf1ois', 'sviwo_atv', '91154cf19bea3f0c5b76f3ce312f948c', '111', 'SVIWO', 1, 10, '2024-02-28 14:44:19', '2024-02-28 14:44:19', NULL, NULL, b'1', 'SVIWO00000002', '0x30383936', '2024-02-28 14:44:19', NULL, b'0'),(10001, 10000, '111', 'k0ugjmf1ois', 'sviwo-asdas546a4s6d5', '92cbf83b2c083554f202b6d419f1f509', '111', 'SVIWO1', 1, 10, '2024-03-28 14:46:53', '2024-03-28 14:46:53', NULL, NULL, b'1', NULL, NULL, '2024-03-28 14:46:53', NULL, b'0'),(10002, 10000, '111', 'k0ugjmf1ois', 'sviwo-23kj4h2k3b4kk2', '63ab88874e683d02ceccff98015e0aff', '111', 'SVIWO2', 1, 10, '2024-05-28 15:06:46', '2024-05-28 15:06:46', NULL, NULL, b'1', NULL, NULL, '2024-05-28 15:06:46', NULL, b'0'),(10003, 10000, '89314404001001776573', 'k0ugjmf1ois', 'sviwo-asidh342sjahdk', '738f2cfe3b5220c69edf3575502bd479', '111', 'SVIWO3', 1, 10, '2024-06-04 14:58:17', '2024-06-04 14:58:17', NULL, NULL, b'1', 'SVIWO00000002', '0x30383936', '2024-06-04 14:58:17', NULL, b'0')
;
UNLOCK TABLES;
COMMIT;
BEGIN;
...
INSERT INTO `sviwo`.`sw_user_device` (`id`,`device_id`,`user_id`,`is_select`,`user_device_type`,`mobile_key`,`speed_limit`,`driving_mode_type`,`energy_recovery`,`create_time`,`update_time`) VALUES (1808048322364051456, 10000, 10000, b'0', b'0', b'0', b'0', 0, 0, '2024-07-02 16:01:27', NULL),(1808048639906418688, 10003, 10000, b'1', b'0', b'0', b'0', 0, 0, '2024-07-02 16:02:42', NULL)
;
UNLOCK TABLES;
COMMIT;
BEGIN;
